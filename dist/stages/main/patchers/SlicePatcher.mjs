...
var SlicePatcher = /** @class */ (function (_super) {
    ...
    SlicePatcher.prototype.getIndexStartSourceToken = function () {
        ...
        var index = tokens.indexOfTokenMatchingPredicate(function (token) { return token.type === SourceType.LBRACKET; }, this.expression.outerEndTokenIndex);
    ...
    SlicePatcher.prototype.getIndexEndSourceToken = function () {
        var tokens = this.context.sourceTokens;
        var index = tokens.lastIndexOfTokenMatchingPredicate(function (token) { return token.type === SourceType.RBRACKET; }, this.outerEndTokenIndex);
