...
var ForPatcher = /** @class */ (function (_super) {
    ...
    ForPatcher.prototype.getIIFEAssignments = function () {
        if (this.willPatchAsIIFE()) {
            var iifeAssignments = [];
            if (this.keyAssignee) {
                iifeAssignments.push.apply(iifeAssignments, tslib_1.__spread(getAssigneeBindings_1.default(this.keyAssignee.node)));
            }
            if (this.valAssignee) {
                iifeAssignments.push.apply(iifeAssignments, tslib_1.__spread(getAssigneeBindings_1.default(this.valAssignee.node)));
            }
