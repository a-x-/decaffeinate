...
var SwitchPatcher = /** @class */ (function (_super) {
    ...
    SwitchPatcher.prototype.getElseToken = function () {
        ...
        var elseTokenIndex = this.indexOfSourceTokenBetweenSourceIndicesMatching(searchStart, searchEnd, function (token) { return token.type === coffee_lex_1.SourceType.ELSE; });
    ...
    SwitchPatcher.prototype.getSwitchToken = function () {
        ...
        if (switchToken.type !== coffee_lex_1.SourceType.SWITCH) {
            throw this.error("unexpected " + coffee_lex_1.SourceType[switchToken.type] + " token at start of 'switch'");
        }
        return switchToken;
    };
    /**
